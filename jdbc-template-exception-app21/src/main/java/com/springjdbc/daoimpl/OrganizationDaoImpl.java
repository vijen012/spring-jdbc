...
public class OrganizationDaoImpl implements OrganizationDao {
	...
	public List<Organization> findAllOrganization() {
		//Introducing error so it will throw exception and we should handile this error in application not in persistent layer
		String sqlQuery = "SELEC * FROM EMPLOYEE.ORGANIZATION";
